...
/*========== ENCODER  FEATURES ==========*/
#define ENC_DT 0.01 // 10 ms (100 Hz) -> updates encoder 100 times per second
...
void calculate_encoder(Encoder_Struct* encoder, TIM_HandleTypeDef* htim);
...
float PIController_Update(PIController *pid, float setpoint, float measurement);
